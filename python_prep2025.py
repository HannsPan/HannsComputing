...
# Fruit 1: apple
# Fruit 2: banana
# Fruit 3: cherry (str dict lst) i ---> loops through and remembers value
...
for i in range(len(students)):
    ...
    current_students = students[i]
    current_marks = marks[i]

    mapping[current_students] = current_marks
...
for i in range(len(boys)):
    ...
    current_boys = boys[i]
    current_girls = girls[i]

    names[current_boys] = current_girls
...
for i in range(len(subjects)):
    ...
    results[current_subjects] = current_marks
...
#         print("Your age input is approved ")
#         break

#     else:

#         print("Age should contains digits only")
...
#         print("Your code is approved ")
#         break

#     else:

#         print("Code should be uppercase only")
...
#         print("Your email is approved ")
#         break

#     else:

#         print("email should contains lowercase only")
...
# range check
# MM is between 01 to 12
# YYYY is between 1900 and 2025
# slicing
...
# numbers.remove(12) # remove 12 from the list

for i in numbers:

    if i % 2 != 0:

        num.append(i) # add all the numbers you want to remove to num[]
...
nums = [2, 4, 6, 8, 10]
midindex = len(nums) // 2 # return the middle index

midlist = nums[midindex - 1: midindex + 2]
print(midlist)
...
# - At least 2 special characters (33–47)
